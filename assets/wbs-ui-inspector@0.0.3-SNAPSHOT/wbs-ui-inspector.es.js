 ...
 */
var t$1;
const i$1 = globalThis.trustedTypes, s$3 = i$1 ? i$1.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, e$2 = `lit$${(Math.random() + "").slice(9)}$`, o$3 = "?" + e$2, n$3 = `<${o$3}>`, l$2 = document, h$1 = (t2 = "") => l$2.createComment(t2), r$1 = (t2) => t2 === null || typeof t2 != "object" && typeof t2 != "function", d = Array.isArray, u = (t2) => {
  var i2;
...
class N {
  ...
  _$AI(t2, i2 = this) {
    t2 = P(this, t2, i2), r$1(t2) ? t2 === w || t2 == null || t2 === "" ? (this._$AH !== w && this._$AR(), this._$AH = w) : t2 !== this._$AH && t2 !== b && this.$(t2) : t2._$litType$ !== void 0 ? this.T(t2) : t2.nodeType !== void 0 ? this.k(t2) : u(t2) ? this.S(t2) : this.$(t2);
  }
  M(t2, i2 = this._$AB) {
...
const metadata = {
  description: "Inspector container component",
  link: "",
  name: "ws-inspector",
  qa: "ws-ui-inspector",
  scope: "@websublime/wbs-ui-inspector",
  version
};
class WsInspector extends ComponentElement {
  constructor() {
    super(metadata);
    this.identifier = uniqueID();
    const classes = this.options.className;
    this.classList.add(...classes);
    this.dataset.qa = metadata.qa;
  }
  connectedCallback() {
    super.connectedCallback();
    const { element } = this.el;
    const htmlElement = element.value;
    if (htmlElement && this.inspect) {
      const tag = this.createSurroundingElement();
      htmlElement.style.outline = "2px solid  #ff00ff";
      htmlElement.prepend(tag);
  ...
  createSurroundingElement() {
    const { registry } = this.el;
    const { scope = "", version: version2 = "" } = registry;
    const tag = document.createElement("span");
    tag.textContent = `${scope}@${version2}`;
  ...
  render() {
    return $` <template id=${this.identifier}></template> `;
  }
}
WsInspector.shadowRootOptions = {
  ...s.shadowRootOptions,
  delegatesFocus: true
};
__decorateClass([
  e$3({ type: Object })
], WsInspector.prototype, "el", 2);
const registerComponent = (options = {}, name = "ws-inspector") => defineWebComponent(name, WsInspector, {
  className: ["ws-inspector"],
  enabled: false,
  ...options
});
registerComponent();
export { WsInspector, registerComponent as registerInspectorComponent };
//# sourceMappingURL=wbs-ui-inspector.es.js.map
